...
# {
#   "retry_join": [
#     "provider=azure tag_key=consul_cluster tag_value=${cluster_name} tenant_id=${tenant_id} client_id=${client_id} subscription_id=${subscription_id} secret_access_key=${client_secret}"
#   ],
...
# retry_join = ["172.16.0.11"] # Consul Server IP
